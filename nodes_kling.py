...
MODE_TEXT2VIDEO = {'standard mode / 5s duration / kling-v1': ('std', '5', 'kling-v1'), 'standard mode / 10s duration / kling-v1': ('std', '10', 'kling-v1'), 'pro mode / 5s duration / kling-v1': ('pro', '5', 'kling-v1'), 'pro mode / 10s duration / kling-v1': ('pro', '10', 'kling-v1'), 'standard mode / 5s duration / kling-v1-6': ('std', '5', 'kling-v1-6'), 'standard mode / 10s duration / kling-v1-6': ('std', '10', 'kling-v1-6'), 'pro mode / 5s duration / kling-v2-master': ('pro', '5', 'kling-v2-master'), 'pro mode / 10s duration / kling-v2-master': ('pro', '10', 'kling-v2-master'), 'standard mode / 5s duration / kling-v2-master': ('std', '5', 'kling-v2-master'), 'standard mode / 10s duration / kling-v2-master': ('std', '10', 'kling-v2-master'), 'pro mode / 5s duration / kling-v2-1-master': ('pro', '5', 'kling-v2-1-master'), 'pro mode / 10s duration / kling-v2-1-master': ('pro', '10', 'kling-v2-1-master'), 'pro mode / 5s duration / kling-v2-5-turbo': ('pro', '5', 'kling-v2-5-turbo'), 'pro mode / 10s duration / kling-v2-5-turbo': ('pro', '10', 'kling-v2-5-turbo')}
...
MODE_START_END_FRAME = {'standard mode / 5s duration / kling-v1': ('std', '5', 'kling-v1'), 'pro mode / 5s duration / kling-v1': ('pro', '5', 'kling-v1'), 'pro mode / 5s duration / kling-v1-5': ('pro', '5', 'kling-v1-5'), 'pro mode / 10s duration / kling-v1-5': ('pro', '10', 'kling-v1-5'), 'pro mode / 5s duration / kling-v1-6': ('pro', '5', 'kling-v1-6'), 'pro mode / 10s duration / kling-v1-6': ('pro', '10', 'kling-v1-6'), 'pro mode / 5s duration / kling-v2-1': ('pro', '5', 'kling-v2-1'), 'pro mode / 10s duration / kling-v2-1': ('pro', '10', 'kling-v2-1'), 'pro mode / 5s duration / kling-v2-5-turbo': ('pro', '5', 'kling-v2-5-turbo'), 'pro mode / 10s duration / kling-v2-5-turbo': ('pro', '10', 'kling-v2-5-turbo')}
'\nReturns a mapping of mode strings to their corresponding (mode, duration, model_name) tuples.\nOnly includes config combos that support the `image_tail` request field.\n\nSee: [Kling API Docs Capability Map](https://app.klingai.com/global/dev/document-api/apiReference/model/skillsMap)\n'
VOICES_CONFIG = {'Melody': ('girlfriend_4_speech02', 'en'), 'Sunny': ('genshin_vindi2', 'en'), 'Sage': ('zhinen_xuesheng', 'en'), 'Ace': ('AOT', 'en'), 'Blossom': ('ai_shatang', 'en'), 'Peppy': ('genshin_klee2', 'en'), 'Dove': ('genshin_kirara', 'en'), 'Shine': ('ai_kaiya', 'en'), 'Anchor': ('oversea_male1', 'en'), 'Lyric': ('ai_chenjiahao_712', 'en'), 'Tender': ('chat1_female_new-3', 'en'), 'Siren': ('chat_0407_5-1', 'en'), 'Zippy': ('cartoon-boy-07', 'en'), 'Bud': ('uk_boy1', 'en'), 'Sprite': ('cartoon-girl-01', 'en'), 'Candy': ('PeppaPig_platform', 'en'), 'Beacon': ('ai_huangzhong_712', 'en'), 'Rock': ('ai_huangyaoshi_712', 'en'), 'Titan': ('ai_laoguowang_712', 'en'), 'Grace': ('chengshu_jiejie', 'en'), 'Helen': ('you_pingjing', 'en'), 'Lore': ('calm_story1', 'en'), 'Crag': ('uk_man2', 'en'), 'Prattle': ('laopopo_speech02', 'en'), 'Hearth': ('heainainai_speech02', 'en'), 'The Reader': ('reader_en_m-v1', 'en'), 'Commercial Lady': ('commercial_lady_en_f-v1', 'en'), '阳光少年': ('genshin_vindi2', 'zh'), '懂事小弟': ('zhinen_xuesheng', 'zh'), '运动少年': ('tiyuxi_xuedi', 'zh'), '青春少女': ('ai_shatang', 'zh'), '温柔小妹': ('genshin_klee2', 'zh'), '元气少女': ('genshin_kirara', 'zh'), '阳光男生': ('ai_kaiya', 'zh'), '幽默小哥': ('tiexin_nanyou', 'zh'), '文艺小哥': ('ai_chenjiahao_712', 'zh'), '甜美邻家': ('girlfriend_1_speech02', 'zh'), '温柔姐姐': ('chat1_female_new-3', 'zh'), '职场女青': ('girlfriend_2_speech02', 'zh'), '活泼男童': ('cartoon-boy-07', 'zh'), '俏皮女童': ('cartoon-girl-01', 'zh'), '稳重老爸': ('ai_huangyaoshi_712', 'zh'), '温柔妈妈': ('you_pingjing', 'zh'), '严肃上司': ('ai_laoguowang_712', 'zh'), '优雅贵妇': ('chengshu_jiejie', 'zh'), '慈祥爷爷': ('zhuxi_speech02', 'zh'), '唠叨爷爷': ('uk_oldman3', 'zh'), '唠叨奶奶': ('laopopo_speech02', 'zh'), '和蔼奶奶': ('heainainai_speech02', 'zh'), '东北老铁': ('dongbeilaotie_speech02', 'zh'), '重庆小伙': ('chongqingxiaohuo_speech02', 'zh'), '四川妹子': ('chuanmeizi_speech02', 'zh'), '潮汕大叔': ('chaoshandashu_speech02', 'zh'), '台湾男生': ('ai_taiwan_man2_speech02', 'zh'), '西安掌柜': ('xianzhanggui_speech02', 'zh'), '天津姐姐': ('tianjinjiejie_speech02', 'zh'), '新闻播报男': ('diyinnansang_DB_CN_M_04-v2', 'zh'), '译制片男': ('yizhipiannan-v1', 'zh'), '撒娇女友': ('tianmeixuemei-v1', 'zh'), '刀片烟嗓': ('daopianyansang-v1', 'zh'), '乖巧正太': ('mengwa-v1', 'zh')}
...
def is_valid_video_response(response: KlingText2VideoResponse) -> bool:
    ...
    return response.data is not None and response.data.task_result is not None and (response.data.task_result.videos is not None) and (len(response.data.task_result.videos) > 0)
...
def is_valid_image_response(response: KlingVirtualTryOnResponse) -> bool:
    ...
    return response.data is not None and response.data.task_result is not None and (response.data.task_result.images is not None) and (len(response.data.task_result.images) > 0)
...
def validate_prompts(prompt: str, negative_prompt: str, max_length: int) -> bool:
    ...
    if negative_prompt and len(negative_prompt) > max_length:
        raise ValueError(f'Negative prompt is too long: {len(negative_prompt)} characters')
    return True
...
def get_video_from_response(response) -> KlingVideoResult:
    ...
    logging.info('Kling task %s succeeded. Video URL: %s', response.data.task_id, video.url)
    return video
...
async def execute_text2video(cls: type[IO.ComfyNode], prompt: str, negative_prompt: str, cfg_scale: float, model_name: str, model_mode: str, duration: str, aspect_ratio: str, camera_control: KlingCameraControl | None=None) -> IO.NodeOutput:
    validate_prompts(prompt, negative_prompt, MAX_PROMPT_LENGTH_T2V)
    task_creation_response = await sync_op(cls, ApiEndpoint(path=PATH_TEXT_TO_VIDEO, method='POST'), response_model=KlingText2VideoResponse, data=KlingText2VideoRequest(prompt=prompt if prompt else None, negative_prompt=negative_prompt if negative_prompt else None, duration=KlingVideoGenDuration(duration), mode=KlingVideoGenMode(model_mode), model_name=KlingVideoGenModelName(model_name), cfg_scale=cfg_scale, aspect_ratio=KlingVideoGenAspectRatio(aspect_ratio), camera_control=camera_control))
    validate_task_creation_response(task_creation_response)
    task_id = task_creation_response.data.task_id
    final_response = await poll_op(cls, ApiEndpoint(path=f'{PATH_TEXT_TO_VIDEO}/{task_id}'), response_model=KlingText2VideoResponse, estimated_duration=AVERAGE_DURATION_T2V, status_extractor=lambda r: r.data.task_status.value if r.data and r.data.task_status else None)
    validate_video_result_response(final_response)
    video = get_video_from_response(final_response)
    return IO.NodeOutput(await download_url_to_video_output(str(video.url)), str(video.id), str(video.duration))

async def execute_image2video(cls: type[IO.ComfyNode], start_frame: torch.Tensor, prompt: str, negative_prompt: str, model_name: str, cfg_scale: float, model_mode: str, aspect_ratio: str, duration: str, camera_control: KlingCameraControl | None=None, end_frame: torch.Tensor | None=None) -> IO.NodeOutput:
    ...
    if model_mode == 'std' and model_name == KlingVideoGenModelName.kling_v2_5_turbo.value:
        model_mode = 'pro'
    task_creation_response = await sync_op(cls, ApiEndpoint(path=PATH_IMAGE_TO_VIDEO, method='POST'), response_model=KlingImage2VideoResponse, data=KlingImage2VideoRequest(model_name=KlingVideoGenModelName(model_name), image=tensor_to_base64_string(start_frame), image_tail=tensor_to_base64_string(end_frame) if end_frame is not None else None, prompt=prompt, negative_prompt=negative_prompt if negative_prompt else None, cfg_scale=cfg_scale, mode=KlingVideoGenMode(model_mode), duration=KlingVideoGenDuration(duration), camera_control=camera_control))
    validate_task_creation_response(task_creation_response)
    task_id = task_creation_response.data.task_id
    final_response = await poll_op(cls, ApiEndpoint(path=f'{PATH_IMAGE_TO_VIDEO}/{task_id}'), response_model=KlingImage2VideoResponse, estimated_duration=AVERAGE_DURATION_I2V, status_extractor=lambda r: r.data.task_status.value if r.data and r.data.task_status else None)
    validate_video_result_response(final_response)
    video = get_video_from_response(final_response)
    return IO.NodeOutput(await download_url_to_video_output(str(video.url)), str(video.id), str(video.duration))

async def execute_video_effect(cls: type[IO.ComfyNode], dual_character: bool, effect_scene: KlingDualCharacterEffectsScene | KlingSingleImageEffectsScene, model_name: str, duration: KlingVideoGenDuration, image_1: torch.Tensor, image_2: torch.Tensor | None=None, model_mode: KlingVideoGenMode | None=None) -> tuple[InputImpl.VideoFromFile, str, str]:
    if dual_character:
        request_input_field = KlingDualCharacterEffectInput(model_name=model_name, mode=model_mode, images=[tensor_to_base64_string(image_1), tensor_to_base64_string(image_2)], duration=duration)
    else:
        request_input_field = KlingSingleImageEffectInput(model_name=model_name, image=tensor_to_base64_string(image_1), duration=duration)
    task_creation_response = await sync_op(cls, endpoint=ApiEndpoint(path=PATH_VIDEO_EFFECTS, method='POST'), response_model=KlingVideoEffectsResponse, data=KlingVideoEffectsRequest(effect_scene=effect_scene, input=request_input_field))
    validate_task_creation_response(task_creation_response)
    task_id = task_creation_response.data.task_id
    final_response = await poll_op(cls, ApiEndpoint(path=f'{PATH_VIDEO_EFFECTS}/{task_id}'), response_model=KlingVideoEffectsResponse, estimated_duration=AVERAGE_DURATION_VIDEO_EFFECTS, status_extractor=lambda r: r.data.task_status.value if r.data and r.data.task_status else None)
    validate_video_result_response(final_response)
    video = get_video_from_response(final_response)
    return (await download_url_to_video_output(str(video.url)), str(video.id), str(video.duration))

async def execute_lipsync(cls: type[IO.ComfyNode], video: Input.Video, audio: Input.Audio | None=None, voice_language: str | None=None, model_mode: str | None=None, text: str | None=None, voice_speed: float | None=None, voice_id: str | None=None) -> IO.NodeOutput:
    if text:
    ...
    if audio:
        audio_url = await upload_audio_to_comfyapi(cls, audio, container_format='mp3', codec_name='libmp3lame', mime_type='audio/mpeg', filename='output.mp3')
    ...
    validate_task_creation_response(task_creation_response)
    task_id = task_creation_response.data.task_id
    final_response = await poll_op(cls, ApiEndpoint(path=f'{PATH_LIP_SYNC}/{task_id}'), response_model=KlingLipSyncResponse, estimated_duration=AVERAGE_DURATION_LIP_SYNC, status_extractor=lambda r: r.data.task_status.value if r.data and r.data.task_status else None)
    validate_video_result_response(final_response)
    video = get_video_from_response(final_response)
    return IO.NodeOutput(await download_url_to_video_output(str(video.url)), str(video.id), str(video.duration))
...
class OmniProFirstLastFrameNode_ISO(IO.ComfyNode):
    ...
    async def execute(cls, model_name: str, prompt: str, duration: int, first_frame: Input.Image, end_frame: Input.Image | None=None, reference_images: Input.Image | None=None) -> IO.NodeOutput:
        ...
        image_list: list[OmniParamImage] = [OmniParamImage(image_url=(await upload_images_to_comfyapi(cls, first_frame, wait_label='Uploading first frame'))[0], type='first_frame')]
        if end_frame is not None:
            validate_image_dimensions(end_frame, min_width=300, min_height=300)
            validate_image_aspect_ratio(end_frame, (1, 2.5), (2.5, 1))
            image_list.append(OmniParamImage(image_url=(await upload_images_to_comfyapi(cls, end_frame, wait_label='Uploading end frame'))[0], type='end_frame'))
...
class OmniProVideoToVideoNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls) -> IO.Schema:
        return IO.Schema(node_id='KlingOmniProVideoToVideoNode_ISO', display_name='Kling Omni Video to Video (Pro)_ISO', category='api node/video/Kling', description='Use a video and up to 4 reference images to generate a video with the latest Kling model.', inputs=[IO.Combo.Input('model_name', options=['kling-video-o1']), IO.String.Input('prompt', multiline=True, tooltip='A text prompt describing the video content. This can include both positive and negative descriptions.'), IO.Combo.Input('aspect_ratio', options=['16:9', '9:16', '1:1']), IO.Int.Input('duration', default=3, min=3, max=10, display_mode=IO.NumberDisplay.slider), IO.Video.Input('reference_video', tooltip='Video to use as a reference.'), IO.Boolean.Input('keep_original_sound', default=True), IO.Image.Input('reference_images', tooltip='Up to 4 additional reference images.', optional=True)], outputs=[IO.Video.Output()], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True)

    @classmethod
    async def execute(cls, model_name: str, prompt: str, aspect_ratio: str, duration: int, reference_video: Input.Video, keep_original_sound: bool, reference_images: Input.Image | None=None) -> IO.NodeOutput:
        prompt = normalize_omni_prompt_references(prompt)
        validate_string(prompt, min_length=1, max_length=2500)
...
class OmniProImageNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls) -> IO.Schema:
        return IO.Schema(node_id='KlingOmniProImageNode_ISO', display_name='Kling Omni Image (Pro)_ISO', category='api node/image/Kling', description='Create or edit images with the latest model from Kling.', inputs=[IO.Combo.Input('model_name', options=['kling-image-o1']), IO.String.Input('prompt', multiline=True, tooltip='A text prompt describing the image content. This can include both positive and negative descriptions.'), IO.Combo.Input('resolution', options=['1K', '2K']), IO.Combo.Input('aspect_ratio', options=['16:9', '9:16', '1:1', '4:3', '3:4', '3:2', '2:3', '21:9']), IO.Image.Input('reference_images', tooltip='Up to 10 additional reference images.', optional=True)], outputs=[IO.Image.Output()], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True)

    @classmethod
    async def execute(cls, model_name: str, prompt: str, resolution: str, aspect_ratio: str, reference_images: Input.Image | None=None) -> IO.NodeOutput:
        prompt = normalize_omni_prompt_references(prompt)
        validate_string(prompt, min_length=1, max_length=2500)
...
class KlingImage2VideoNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls) -> IO.Schema:
        return IO.Schema(node_id='KlingImage2VideoNode_ISO', display_name='Kling Image to Video_ISO', category='api node/video/Kling', description='Kling Image to Video Node', inputs=[IO.Image.Input('start_frame', tooltip='The reference image used to generate the video.'), IO.String.Input('prompt', multiline=True, tooltip='Positive text prompt'), IO.String.Input('negative_prompt', multiline=True, tooltip='Negative text prompt'), IO.Combo.Input('model_name', options=KlingVideoGenModelName, default='kling-v2-master'), IO.Float.Input('cfg_scale', default=0.8, min=0.0, max=1.0), IO.Combo.Input('mode', options=KlingVideoGenMode, default=KlingVideoGenMode.std), IO.Combo.Input('aspect_ratio', options=KlingVideoGenAspectRatio, default=KlingVideoGenAspectRatio.field_16_9), IO.Combo.Input('duration', options=KlingVideoGenDuration, default=KlingVideoGenDuration.field_5)], outputs=[IO.Video.Output(), IO.String.Output(display_name='video_id'), IO.String.Output(display_name='duration')], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True)

    @classmethod
    async def execute(cls, start_frame: torch.Tensor, prompt: str, negative_prompt: str, model_name: str, cfg_scale: float, mode: str, aspect_ratio: str, duration: str, camera_control: KlingCameraControl | None=None, end_frame: torch.Tensor | None=None) -> IO.NodeOutput:
        return await execute_image2video(cls, start_frame=start_frame, prompt=prompt, negative_prompt=negative_prompt, cfg_scale=cfg_scale, model_name=model_name, aspect_ratio=aspect_ratio, model_mode=mode, duration=duration, camera_control=camera_control, end_frame=end_frame)
...
class KlingStartEndFrameNode_ISO(IO.ComfyNode):
    ...
    def define_schema(cls) -> IO.Schema:
        ...
        return IO.Schema(node_id='KlingStartEndFrameNode_ISO', display_name='Kling Start-End Frame to Video_ISO', category='api node/video/Kling', description='Generate a video sequence that transitions between your provided start and end images. The node creates all frames in between, producing a smooth transformation from the first frame to the last.', inputs=[IO.Image.Input('start_frame', tooltip='Reference Image - URL or Base64 encoded string, cannot exceed 10MB, resolution not less than 300*300px, aspect ratio between 1:2.5 ~ 2.5:1. Base64 should not include data:image prefix.'), IO.Image.Input('end_frame', tooltip='Reference Image - End frame control. URL or Base64 encoded string, cannot exceed 10MB, resolution not less than 300*300px. Base64 should not include data:image prefix.'), IO.String.Input('prompt', multiline=True, tooltip='Positive text prompt'), IO.String.Input('negative_prompt', multiline=True, tooltip='Negative text prompt'), IO.Float.Input('cfg_scale', default=0.5, min=0.0, max=1.0), IO.Combo.Input('aspect_ratio', options=['16:9', '9:16', '1:1']), IO.Combo.Input('mode', options=modes, default=modes[8], tooltip='The configuration to use for the video generation following the format: mode / duration / model_name.')], outputs=[IO.Video.Output(), IO.String.Output(display_name='video_id'), IO.String.Output(display_name='duration')], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True)

    @classmethod
    async def execute(cls, start_frame: torch.Tensor, end_frame: torch.Tensor, prompt: str, negative_prompt: str, cfg_scale: float, aspect_ratio: str, mode: str) -> IO.NodeOutput:
        mode, duration, model_name = MODE_START_END_FRAME[mode]
        return await execute_image2video(cls, prompt=prompt, negative_prompt=negative_prompt, model_name=model_name, start_frame=start_frame, cfg_scale=cfg_scale, model_mode=mode, aspect_ratio=aspect_ratio, duration=duration, end_frame=end_frame)

class KlingVideoExtendNode_ISO(IO.ComfyNode):

    @classmethod
    def define_schema(cls) -> IO.Schema:
        return IO.Schema(node_id='KlingVideoExtendNode_ISO', display_name='Kling Video Extend_ISO', category='api node/video/Kling', description='Kling Video Extend Node. Extend videos made by other Kling nodes. The video_id is created by using other Kling Nodes.', inputs=[IO.String.Input('prompt', multiline=True, tooltip='Positive text prompt for guiding the video extension'), IO.String.Input('negative_prompt', multiline=True, tooltip='Negative text prompt for elements to avoid in the extended video'), IO.Float.Input('cfg_scale', default=0.5, min=0.0, max=1.0), IO.String.Input('video_id', force_input=True, tooltip='The ID of the video to be extended. Supports videos generated by text-to-video, image-to-video, and previous video extension operations. Cannot exceed 3 minutes total duration after extension.')], outputs=[IO.Video.Output(), IO.String.Output(display_name='video_id'), IO.String.Output(display_name='duration')], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True)

    @classmethod
    async def execute(cls, prompt: str, negative_prompt: str, cfg_scale: float, video_id: str) -> IO.NodeOutput:
        validate_prompts(prompt, negative_prompt, MAX_PROMPT_LENGTH_T2V)
        task_creation_response = await sync_op(cls, ApiEndpoint(path=PATH_VIDEO_EXTEND, method='POST'), response_model=KlingVideoExtendResponse, data=KlingVideoExtendRequest(prompt=prompt if prompt else None, negative_prompt=negative_prompt if negative_prompt else None, cfg_scale=cfg_scale, video_id=video_id))
        validate_task_creation_response(task_creation_response)
        task_id = task_creation_response.data.task_id
        final_response = await poll_op(cls, ApiEndpoint(path=f'{PATH_VIDEO_EXTEND}/{task_id}'), response_model=KlingVideoExtendResponse, estimated_duration=AVERAGE_DURATION_VIDEO_EXTEND, status_extractor=lambda r: r.data.task_status.value if r.data and r.data.task_status else None)
        validate_video_result_response(final_response)
        video = get_video_from_response(final_response)
        return IO.NodeOutput(await download_url_to_video_output(str(video.url)), str(video.id), str(video.duration))
...
class KlingDualCharacterVideoEffectNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls) -> IO.Schema:
        return IO.Schema(node_id='KlingDualCharacterVideoEffectNode_ISO', display_name='Kling Dual Character Video Effects_ISO', category='api node/video/Kling', description='Achieve different special effects when generating a video based on the effect_scene. First image will be positioned on left side, second on right side of the composite.', inputs=[IO.Image.Input('image_left', tooltip='Left side image'), IO.Image.Input('image_right', tooltip='Right side image'), IO.Combo.Input('effect_scene', options=[i.value for i in KlingDualCharacterEffectsScene]), IO.Combo.Input('model_name', options=[i.value for i in KlingCharacterEffectModelName], default='kling-v1'), IO.Combo.Input('mode', options=[i.value for i in KlingVideoGenMode], default='std'), IO.Combo.Input('duration', options=[i.value for i in KlingVideoGenDuration])], outputs=[IO.Video.Output(), IO.String.Output(display_name='duration')], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True)

    @classmethod
    async def execute(cls, image_left: torch.Tensor, image_right: torch.Tensor, effect_scene: KlingDualCharacterEffectsScene, model_name: KlingCharacterEffectModelName, mode: KlingVideoGenMode, duration: KlingVideoGenDuration) -> IO.NodeOutput:
        video, _, duration = await execute_video_effect(cls, dual_character=True, effect_scene=effect_scene, model_name=model_name, model_mode=mode, duration=duration, image_1=image_left, image_2=image_right)
...
class KlingSingleImageVideoEffectNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls) -> IO.Schema:
        return IO.Schema(node_id='KlingSingleImageVideoEffectNode_ISO', display_name='Kling Video Effects_ISO', category='api node/video/Kling', description='Achieve different special effects when generating a video based on the effect_scene.', inputs=[IO.Image.Input('image', tooltip=' Reference Image. URL or Base64 encoded string (without data:image prefix). File size cannot exceed 10MB, resolution not less than 300*300px, aspect ratio between 1:2.5 ~ 2.5:1'), IO.Combo.Input('effect_scene', options=[i.value for i in KlingSingleImageEffectsScene]), IO.Combo.Input('model_name', options=[i.value for i in KlingSingleImageEffectModelName]), IO.Combo.Input('duration', options=[i.value for i in KlingVideoGenDuration])], outputs=[IO.Video.Output(), IO.String.Output(display_name='video_id'), IO.String.Output(display_name='duration')], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True)

    @classmethod
    async def execute(cls, image: torch.Tensor, effect_scene: KlingSingleImageEffectsScene, model_name: KlingSingleImageEffectModelName, duration: KlingVideoGenDuration) -> IO.NodeOutput:
        return IO.NodeOutput(*await execute_video_effect(cls, dual_character=False, effect_scene=effect_scene, model_name=model_name, duration=duration, image_1=image))
...
class KlingLipSyncAudioToVideoNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls) -> IO.Schema:
        return IO.Schema(node_id='KlingLipSyncAudioToVideoNode_ISO', display_name='Kling Lip Sync Video with Audio_ISO', category='api node/video/Kling', description='Kling Lip Sync Audio to Video Node. Syncs mouth movements in a video file to the audio content of an audio file. When using, ensure that the audio contains clearly distinguishable vocals and that the video contains a distinct face. The audio file should not be larger than 5MB. The video file should not be larger than 100MB, should have height/width between 720px and 1920px, and should be between 2s and 10s in length.', inputs=[IO.Video.Input('video'), IO.Audio.Input('audio'), IO.Combo.Input('voice_language', options=[i.value for i in KlingLipSyncVoiceLanguage], default='en')], outputs=[IO.Video.Output(), IO.String.Output(display_name='video_id'), IO.String.Output(display_name='duration')], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True)

    @classmethod
    async def execute(cls, video: Input.Video, audio: Input.Audio, voice_language: str) -> IO.NodeOutput:
        return await execute_lipsync(cls, video=video, audio=audio, voice_language=voice_language, model_mode='audio2video')
...
class KlingVirtualTryOnNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls) -> IO.Schema:
        return IO.Schema(node_id='KlingVirtualTryOnNode_ISO', display_name='Kling Virtual Try On_ISO', category='api node/image/Kling', description='Kling Virtual Try On Node. Input a human image and a cloth image to try on the cloth on the human. You can merge multiple clothing item pictures into one image with a white background.', inputs=[IO.Image.Input('human_image'), IO.Image.Input('cloth_image'), IO.Combo.Input('model_name', options=[i.value for i in KlingVirtualTryOnModelName], default='kolors-virtual-try-on-v1')], outputs=[IO.Image.Output()], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True)

    @classmethod
    async def execute(cls, human_image: torch.Tensor, cloth_image: torch.Tensor, model_name: KlingVirtualTryOnModelName) -> IO.NodeOutput:
        task_creation_response = await sync_op(cls, ApiEndpoint(path=PATH_VIRTUAL_TRY_ON, method='POST'), response_model=KlingVirtualTryOnResponse, data=KlingVirtualTryOnRequest(human_image=tensor_to_base64_string(human_image), cloth_image=tensor_to_base64_string(cloth_image), model_name=model_name))
        validate_task_creation_response(task_creation_response)
        task_id = task_creation_response.data.task_id
        final_response = await poll_op(cls, ApiEndpoint(path=f'{PATH_VIRTUAL_TRY_ON}/{task_id}'), response_model=KlingVirtualTryOnResponse, estimated_duration=AVERAGE_DURATION_VIRTUAL_TRY_ON, status_extractor=lambda r: r.data.task_status.value if r.data and r.data.task_status else None)
...
class KlingImageGenerationNode_ISO(IO.ComfyNode):
    ...
    async def execute(cls, model_name: KlingImageGenModelName, prompt: str, negative_prompt: str, image_type: KlingImageGenImageReferenceType, image_fidelity: float, human_fidelity: float, n: int, aspect_ratio: KlingImageGenAspectRatio, image: torch.Tensor | None=None) -> IO.NodeOutput:
        ...
        task_creation_response = await sync_op(cls, ApiEndpoint(path=PATH_IMAGE_GENERATIONS, method='POST'), response_model=KlingImageGenerationsResponse, data=KlingImageGenerationsRequest(model_name=model_name, prompt=prompt, negative_prompt=negative_prompt, image=image, image_reference=image_type, image_fidelity=image_fidelity, human_fidelity=human_fidelity, n=n, aspect_ratio=aspect_ratio))
        validate_task_creation_response(task_creation_response)
        task_id = task_creation_response.data.task_id
        final_response = await poll_op(cls, ApiEndpoint(path=f'{PATH_IMAGE_GENERATIONS}/{task_id}'), response_model=KlingImageGenerationsResponse, estimated_duration=AVERAGE_DURATION_IMAGE_GEN, status_extractor=lambda r: r.data.task_status.value if r.data and r.data.task_status else None)
        validate_image_result_response(final_response)
        images = get_images_from_response(final_response)
        return IO.NodeOutput(await image_result_to_node_output(images))

class KlingExtension_ISO(ComfyExtension):

    @override
    async def get_node_list(self) -> list[type[IO.ComfyNode]]:
        return [KlingCameraControls_ISO, KlingTextToVideoNode_ISO, KlingImage2VideoNode_ISO, KlingCameraControlI2VNode_ISO, KlingCameraControlT2VNode_ISO, KlingStartEndFrameNode_ISO, KlingVideoExtendNode_ISO, KlingLipSyncAudioToVideoNode_ISO, KlingLipSyncTextToVideoNode_ISO, KlingVirtualTryOnNode_ISO, KlingImageGenerationNode_ISO, KlingSingleImageVideoEffectNode_ISO, KlingDualCharacterVideoEffectNode_ISO, OmniProTextToVideoNode_ISO, OmniProFirstLastFrameNode_ISO, OmniProImageToVideoNode_ISO, OmniProVideoToVideoNode_ISO, OmniProEditVideoNode_ISO]

async def comfy_entrypoint() -> KlingExtension_ISO:
    return KlingExtension_ISO()