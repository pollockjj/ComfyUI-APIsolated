...
async def poll_until_finished(node_cls: type[IO.ComfyNode], response: TripoTaskResponse, average_duration: Optional[int]=None) -> IO.NodeOutput:
    ...
    response_poll = await poll_op(node_cls, poll_endpoint=ApiEndpoint(path=f'/proxy/tripo/v2/openapi/task/{task_id}'), response_model=TripoTaskResponse, completed_statuses=[TripoTaskStatus.SUCCESS], failed_statuses=[TripoTaskStatus.FAILED, TripoTaskStatus.CANCELLED, TripoTaskStatus.UNKNOWN, TripoTaskStatus.BANNED, TripoTaskStatus.EXPIRED], status_extractor=lambda x: x.data.status, progress_extractor=lambda x: x.data.progress, estimated_duration=average_duration)
...
class TripoImageToModelNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return IO.Schema(node_id='TripoImageToModelNode_ISO', display_name='Tripo: Image to Model_ISO', category='api node/3d/Tripo', inputs=[IO.Image.Input('image'), IO.Combo.Input('model_version', options=TripoModelVersion, tooltip='The model version to use for generation', optional=True), IO.Combo.Input('style', options=TripoStyle, default='None', optional=True), IO.Boolean.Input('texture', default=True, optional=True), IO.Boolean.Input('pbr', default=True, optional=True), IO.Int.Input('model_seed', default=42, optional=True), IO.Combo.Input('orientation', options=TripoOrientation, default=TripoOrientation.DEFAULT, optional=True), IO.Int.Input('texture_seed', default=42, optional=True), IO.Combo.Input('texture_quality', default='standard', options=['standard', 'detailed'], optional=True), IO.Combo.Input('texture_alignment', default='original_image', options=['original_image', 'geometry'], optional=True), IO.Int.Input('face_limit', default=-1, min=-1, max=500000, optional=True), IO.Boolean.Input('quad', default=False, optional=True)], outputs=[IO.String.Output(display_name='model_file'), IO.Custom('MODEL_TASK_ID').Output(display_name='model task_id')], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True, is_output_node=True)
    ...
    async def execute(cls, image: torch.Tensor, model_version: Optional[str]=None, style: Optional[str]=None, texture: Optional[bool]=None, pbr: Optional[bool]=None, model_seed: Optional[int]=None, orientation=None, texture_seed: Optional[int]=None, texture_quality: Optional[str]=None, texture_alignment: Optional[str]=None, face_limit: Optional[int]=None, quad: Optional[bool]=None) -> IO.NodeOutput:
        ...
        tripo_file = TripoFileReference(root=TripoUrlReference(url=(await upload_images_to_comfyapi(cls, image, max_images=1))[0], type='jpeg'))
...
class TripoTextureNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return IO.Schema(node_id='TripoTextureNode_ISO', display_name='Tripo: Texture model_ISO', category='api node/3d/Tripo', inputs=[IO.Custom('MODEL_TASK_ID').Input('model_task_id'), IO.Boolean.Input('texture', default=True, optional=True), IO.Boolean.Input('pbr', default=True, optional=True), IO.Int.Input('texture_seed', default=42, optional=True), IO.Combo.Input('texture_quality', default='standard', options=['standard', 'detailed'], optional=True), IO.Combo.Input('texture_alignment', default='original_image', options=['original_image', 'geometry'], optional=True)], outputs=[IO.String.Output(display_name='model_file'), IO.Custom('MODEL_TASK_ID').Output(display_name='model task_id')], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True, is_output_node=True)

    @classmethod
    async def execute(cls, model_task_id, texture: Optional[bool]=None, pbr: Optional[bool]=None, texture_seed: Optional[int]=None, texture_quality: Optional[str]=None, texture_alignment: Optional[str]=None) -> IO.NodeOutput:
        response = await sync_op(cls, endpoint=ApiEndpoint(path='/proxy/tripo/v2/openapi/task', method='POST'), response_model=TripoTaskResponse, data=TripoTextureModelRequest(original_model_task_id=model_task_id, texture=texture, pbr=pbr, texture_seed=texture_seed, texture_quality=texture_quality, texture_alignment=texture_alignment))
        return await poll_until_finished(cls, response, average_duration=80)
...
class TripoRefineNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return IO.Schema(node_id='TripoRefineNode_ISO', display_name='Tripo: Refine Draft model_ISO', category='api node/3d/Tripo', description='Refine a draft model created by v1.4 Tripo models only.', inputs=[IO.Custom('MODEL_TASK_ID').Input('model_task_id', tooltip='Must be a v1.4 Tripo model')], outputs=[IO.String.Output(display_name='model_file'), IO.Custom('MODEL_TASK_ID').Output(display_name='model task_id')], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True, is_output_node=True)

    @classmethod
    async def execute(cls, model_task_id) -> IO.NodeOutput:
        response = await sync_op(cls, endpoint=ApiEndpoint(path='/proxy/tripo/v2/openapi/task', method='POST'), response_model=TripoTaskResponse, data=TripoRefineModelRequest(draft_model_task_id=model_task_id))
...
class TripoRigNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return IO.Schema(node_id='TripoRigNode_ISO', display_name='Tripo: Rig model_ISO', category='api node/3d/Tripo', inputs=[IO.Custom('MODEL_TASK_ID').Input('original_model_task_id')], outputs=[IO.String.Output(display_name='model_file'), IO.Custom('RIG_TASK_ID').Output(display_name='rig task_id')], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True, is_output_node=True)

    @classmethod
    async def execute(cls, original_model_task_id) -> IO.NodeOutput:
        response = await sync_op(cls, endpoint=ApiEndpoint(path='/proxy/tripo/v2/openapi/task', method='POST'), response_model=TripoTaskResponse, data=TripoAnimateRigRequest(original_model_task_id=original_model_task_id, out_format='glb', spec='tripo'))
...
class TripoRetargetNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return IO.Schema(node_id='TripoRetargetNode_ISO', display_name='Tripo: Retarget rigged model_ISO', category='api node/3d/Tripo', inputs=[IO.Custom('RIG_TASK_ID').Input('original_model_task_id'), IO.Combo.Input('animation', options=['preset:idle', 'preset:walk', 'preset:climb', 'preset:jump', 'preset:slash', 'preset:shoot', 'preset:hurt', 'preset:fall', 'preset:turn'])], outputs=[IO.String.Output(display_name='model_file'), IO.Custom('RETARGET_TASK_ID').Output(display_name='retarget task_id')], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True, is_output_node=True)

    @classmethod
    async def execute(cls, original_model_task_id, animation: str) -> IO.NodeOutput:
        response = await sync_op(cls, endpoint=ApiEndpoint(path='/proxy/tripo/v2/openapi/task', method='POST'), response_model=TripoTaskResponse, data=TripoAnimateRetargetRequest(original_model_task_id=original_model_task_id, animation=animation, out_format='glb', bake_animation=True))
...
class TripoConversionNode_ISO(IO.ComfyNode):
    ...
    @classmethod
    def define_schema(cls):
        return IO.Schema(node_id='TripoConversionNode_ISO', display_name='Tripo: Convert model_ISO', category='api node/3d/Tripo', inputs=[IO.Custom('MODEL_TASK_ID,RIG_TASK_ID,RETARGET_TASK_ID').Input('original_model_task_id'), IO.Combo.Input('format', options=['GLTF', 'USDZ', 'FBX', 'OBJ', 'STL', '3MF']), IO.Boolean.Input('quad', default=False, optional=True), IO.Int.Input('face_limit', default=-1, min=-1, max=500000, optional=True), IO.Int.Input('texture_size', default=4096, min=128, max=4096, optional=True), IO.Combo.Input('texture_format', options=['BMP', 'DPX', 'HDR', 'JPEG', 'OPEN_EXR', 'PNG', 'TARGA', 'TIFF', 'WEBP'], default='JPEG', optional=True)], outputs=[], hidden=[IO.Hidden.auth_token_comfy_org, IO.Hidden.api_key_comfy_org, IO.Hidden.unique_id], is_api_node=True, is_output_node=True)
    ...
    @classmethod
    async def execute(cls, original_model_task_id, format: str, quad: bool, face_limit: int, texture_size: int, texture_format: str) -> IO.NodeOutput:
        if not original_model_task_id:
            raise RuntimeError('original_model_task_id is required')
        response = await sync_op(cls, endpoint=ApiEndpoint(path='/proxy/tripo/v2/openapi/task', method='POST'), response_model=TripoTaskResponse, data=TripoConvertModelRequest(original_model_task_id=original_model_task_id, format=format, quad=quad if quad else None, face_limit=face_limit if face_limit != -1 else None, texture_size=texture_size if texture_size != 4096 else None, texture_format=texture_format if texture_format != 'JPEG' else None))
        return await poll_until_finished(cls, response, average_duration=30)

class TripoExtension_ISO(ComfyExtension):

    @override
    async def get_node_list(self) -> list[type[IO.ComfyNode]]:
        return [TripoTextToModelNode_ISO, TripoImageToModelNode_ISO, TripoMultiviewToModelNode_ISO, TripoTextureNode_ISO, TripoRefineNode_ISO, TripoRigNode_ISO, TripoRetargetNode_ISO, TripoConversionNode_ISO]

async def comfy_entrypoint() -> TripoExtension_ISO:
    return TripoExtension_ISO()